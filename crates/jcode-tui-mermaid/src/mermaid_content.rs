...
pub fn terminal_theme() -> Theme {
    Theme {
        ...
        font_family: "Inter, \"Noto Sans CJK SC\", \"Noto Sans CJK JP\", \"Noto Sans CJK KR\", \"Noto Sans SC\", \"PingFang SC\", \"Microsoft YaHei\", \"WenQuanYi Micro Hei\", ui-sans-serif, system-ui, -apple-system, Segoe UI, sans-serif"
            .to_string(),
        font_size: 15.0,
